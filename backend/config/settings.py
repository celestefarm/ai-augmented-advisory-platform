...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        "OPTIONS": {
            "min_length": 8, # Enforcing minimum password length of 8 characters as required from the spec
        }
    },
    {
...
# Password Hashers (bcrypt with 12 rounds as per spec)
PASSWORD_HASHERS = [
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='edetdestiny700@gmail.com')
